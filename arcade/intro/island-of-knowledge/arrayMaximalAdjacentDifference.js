...
assert.equal(arrayMaximalAdjacentDifference(inputArray), 3);

inputArray = [1, 1, 1, 1];
assert.equal(arrayMaximalAdjacentDifference(inputArray), 0);

inputArray = [-1, 4, 10, 3, -2];
assert.equal(arrayMaximalAdjacentDifference(inputArray), 7);
